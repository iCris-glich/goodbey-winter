...
screen main_menu():
    ...
    # Fondo principal
    add im.Scale("images/backgrounds/Gemini_Generated_Image_vlwmwavlwmwavlwm.png", 1920, 1080)

    # Música
    on "show" action Play("music", "audio/soundtrack/Love Plus [NDS Music] - Eternal Diary (Main Menu) - Aedithy.mp3", loop=True)
    ...
    vbox:
        ...
        textbutton "Iniciar juego" style "rounded_button" action Start()
        textbutton "Cargar partida" style "rounded_button" action ShowMenu('load')
        textbutton "Opciones" style "rounded_button" action ShowMenu('preferences')
        textbutton "Salir" style "rounded_button" action Quit(confirm=True)


style rounded_button:
    background Frame("images/modern-neon-glowing-buttons-minimal-neon-button-for-web-design-app-game-interface-png.webp", 10, 10)
    hover_background Frame("images/neon-button-glowing-neon-button-png.webp")
    xminimum 200  
    yminimum 60
    padding (15, 25)
